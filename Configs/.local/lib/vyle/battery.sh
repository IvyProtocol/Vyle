...
if [ "$state" = "charging" ]; then
  ...
  if [ "$display_percent" -le 10 ]; then
    display_text_icon="󰂎"
  elif [ "$display_percent" -le 20 ]; then
    display_text_icon="󰁺"
  elif [ "$display_percent" -le 30 ]; then
    display_text_icon="󰁻"
  elif [ "$display_percent" -le 40 ]; then
    display_text_icon="󰁼"
  elif [ "$display_percent" -le 50 ]; then
    display_text_icon="󰁽"
  elif [ "$display_percent" -le 60 ]; then
    display_text_icon="󰁾"
  elif [ "$display_percent" -le 70 ]; then
    display_text_icon="󰁿"
  elif [ "$display_percent" -le 80 ]; then
    display_text_icon="󰂀"
  elif [ "$display_percent" -le 90 ]; then
    display_text_icon="󰁹"
  else
    display_text_icon="󰂁"
  fi
