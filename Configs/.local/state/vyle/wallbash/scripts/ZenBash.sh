...
content_path="$XDG_CONFIG_HOME/Wall-Ways/zen#Content.dcol"
...
chrome_path="$XDG_CONFIG_HOME/Wall-Ways/zen#Chrome.dcol"
...
if ! $run_browser; then
  rules_file="$XDG_CONFIG_HOME/hypr/windowrules.conf"
