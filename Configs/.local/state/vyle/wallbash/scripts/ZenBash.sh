...
content_path="$HOME/.config/vyle/Wall-Ways/zen#Content.dcol"
...
chrome_path="$HOME/.config/vyle/Wall-Ways/zen#Chrome.dcol"
chrome_entry="${zenbash_dir}/zenbashChrome.css|\$RUN:<LIB_DIR>ZenBash.sh -r >/dev/null 2>&1 &"
tmp_chrome=$(mktemp)
...
if ! $run_browser; then
    rules_file="$HOME/.config/hypr/hyprland/windowrules.conf"
